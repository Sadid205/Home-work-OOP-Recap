...
class Byke(Engine):
    def __init__(self,fuel,piston,battery,valves,spark_plugs,tires,brakes,fuel_tank,seat,frame)->None:
        self.tires = tires
        self.brakes = brakes
        self.fuel_tank = fuel_tank
        self.seat = seat
        self.frame = frame
        Engine.__init__(self,fuel,piston,battery,valves,spark_plugs)
...
class Honda(Byke):
    def __init__(self, fuel, piston, battery, valves, spark_plugs,tires,brakes,fuel_tank,seat,frame):
        super().__init__(fuel, piston, battery, valves, spark_plugs,tires,brakes,fuel_tank,seat,frame)
